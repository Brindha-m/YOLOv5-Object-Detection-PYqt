...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_img.setMinimumSize(QtCore.QSize(700, 100))
        self.pushButton_img.setMaximumSize(QtCore.QSize(5050, 100))
        font = QtGui.QFont()
        ...
        self.pushButton_camera.setMinimumSize(QtCore.QSize(700, 100))
        self.pushButton_camera.setMaximumSize(QtCore.QSize(5050, 100))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.pushButton_video.setMinimumSize(QtCore.QSize(700, 100))
        self.pushButton_video.setMaximumSize(QtCore.QSize(5050, 100))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "PyQt5 YOLO DETECTIONS"))
        self.pushButton_img.setText(_translate("MainWindow", "IMAGE DETECTION📸"))
        self.pushButton_camera.setText(_translate("MainWindow", "LIVE WEBCAM DETECTION💻"))
    ...
    def button_image_open(self):
        ...
        img_name, _ = QtWidgets.QFileDialog.getOpenFileName(self, "IMAGE", "", "*.jpg;;*.png;;All Files(*)")
    ...
    def button_video_open(self):
        video_name, _ = QtWidgets.QFileDialog.getOpenFileName(self, "VIDEO", "", "*.mp4;;*.avi;;All Files(*)")
        flag = self.cap.open(video_name)
        if flag == False:
            QtWidgets.QMessageBox.warning(self, u"Warning",  buttons=QtWidgets.QMessageBox.Ok, defaultButton=QtWidgets.QMessageBox.Ok)
        else:
    ...
    def button_camera_open(self):
        if not self.timer_video.isActive():
            ...
            if flag == False:
                ...
                self.pushButton_video.setDisabled(True)
                self.pushButton_img.setDisabled(True)
                self.pushButton_camera.setText(u"LIVE DETECTING ")
        else:
            ...
            self.pushButton_camera.setText("LIVE WEBCAM DETECTION")
